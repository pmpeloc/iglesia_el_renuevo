...
En aplicaciones, desafíos y llamados finales, **nunca usar el imperativo en segunda persona** dirigido a la congregación (ej: "Dejá de hacer esto", "Pedile a Dios...", "Tenés que..."). Esto suena a que el predicador se posiciona como el único que está bien y el resto está equivocado.

**En cambio, usar primera persona del plural** ("debemos", "necesitamos", "podemos", "nos toca"), incluyendo a Misael como parte de la congregación que también necesita el desafío.

- ❌ "Dejá de servir con tu propia fuerza."
- ✅ "Debemos dejar de servir con nuestra propia fuerza."
- ❌ "Pedile al Espíritu Santo que tome el control."
- ✅ "Necesitamos pedirle al Espíritu Santo que tome el control."

Las preguntas reflexivas (¿...?) pueden mantenerse en segunda persona/plural cuando buscan introspección personal (ej: "¿De dónde sacamos la fuerza para servir?" o "¿le hemos cedido a Dios el control?"), priorizando siempre el plural inclusivo.

Esta regla aplica a **todas las reuniones** (general, jóvenes, adolescentes, servidores, oración) y a todos los formatos (bosquejo, HTML personal, apuntes, slides).
